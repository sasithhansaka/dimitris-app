...
const WALLET_REWARDS: WalletReward[] = [
    {
        id: "1",
        title: "Storewide seasonal sale reward",
        value: "$8.40",
        brand: NORTHWIND,
    },
    {
        id: "2",
        title: "Electronics cashback reward",
        value: "$12.00",
        brand: CIRCUIT,
    },
];
...
const RECEIPT_SUBMISSIONS: ReceiptSubmission[] = [
    {
        id: "1",
        couponCount: 2,
        submittedAt: "2026-08-28T14:30:00",
        status: "approved",
    },
    {
        id: "2",
        couponCount: 1,
        submittedAt: "2026-09-02T09:15:00",
        status: "in-review",
    },
];
                            ...
                            {savedCoupons.length > 0 && (
                                <section aria-labelledby="saved-coupons-heading">
                                    <div className="flex items-baseline justify-between gap-4">
                                        <h2
                                            id="saved-coupons-heading"
                                            className="u-display text-[1.45rem]"
                                        >
                                            Saved coupons
                                        </h2>
                                        <p className="u-nums text-[0.8rem] text-ink-3">
                                            {savedCoupons.length}
                                        </p>
                                    </div>
                                    <div className="mt-5 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
                                        {savedCoupons.map((coupon) => (
                                            ...
                                            >
                                                ...
                                                <p className="u-value mt-4 text-[1.45rem] text-ink">
                                                    {coupon.reward}
                                                </p>
                                                <p className="mt-2 text-[0.8rem] leading-relaxed text-ink-3">
                                                    Remembered only. It has not
                                                    been claimed or registered.
                                                </p>
                            ...
                            {WALLET_REWARDS.map((reward) => (
                                ...
                                >
                                    <div className="flex items-center justify-between gap-3">
                                        ...
                                        <span className="u-label text-save-ink">
                                            Received reward
                                        </span>
                                    </div>
                                    <p className="u-value mt-5 text-[1.65rem] text-ink">
                                        {reward.value}
                                    </p>
                                ...
                                >
                                    ...
                                    <div className="min-w-0 flex-1">
                                        <p className="text-[0.88rem] font-semibold text-ink">
                                            Receipt for {submission.couponCount}{" "}
                                            coupon
                                            {submission.couponCount === 1
                                                ? ""
                                                : "s"}
                                        </p>
...
function Empty({
    ...
    return (
        <div className="rounded-lg border border-dashed border-rule-strong bg-surface px-6 py-14 text-center">
            ...
            <p className="mx-auto mt-2 max-w-[48ch] text-[0.86rem] leading-relaxed text-ink-3">
                {body}
            </p>
            <Link
                href={href}
                className="mt-6 inline-flex min-h-11 items-center rounded-md bg-brand px-5 text-[0.84rem] font-semibold text-paper"
            >
                {action}
            </Link>
        </div>
