...
export default function CreateStampProgram({
    nextStampCode,
    products,
}: {
    nextStampCode: string;
    ...
    const submit = (e: React.FormEvent) => {
        e.preventDefault();
        post(stampProgramsRoutes.store().url, { forceFormData: true });
    };

    return (
        <>
            <Head title="Create Stamp Program" />
                ...
                <div className="mx-auto w-full max-w-5xl">
                    <div className="mb-5 space-y-1">
                        ...
                        <p className="text-sm text-muted-foreground">
                            Add a new stamp program and link it to one or more
                            products.
                        </p>
                    </div>
...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: "Create", href: stampProgramsRoutes.create() },
];

CreateStampProgram.layout = {
    breadcrumbs,
};
