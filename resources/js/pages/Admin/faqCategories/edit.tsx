...
export default function EditFaqCategory({
    ...
    const { data, setData, post, processing, errors } = useForm({
        ...
        faqs: (category.faqs && category.faqs.length > 0
            ? category.faqs
    ...
    const originalBanner = category.banner
        ? `/storage/${category.banner}`
        : null;
    ...
    const submit = (e: React.FormEvent) => {
        e.preventDefault();
        post(faqCategoriesRoutes.update(category.id).url, {
            forceFormData: true,
        });
    };
                ...
                <div className="mx-auto w-full max-w-5xl">
                    <div className="mb-5 space-y-1">
                        ...
                        <p className="text-sm text-muted-foreground">
                            Update the category and its questions & answers.
                        </p>
                    </div>
